  ...
  return (
    <div className="pink-shape min-h-[95vh] bg-white flex justify-center z-10">
      <div className="z-10 mt-28">
        ...
        <div className="z-10 w-full pt-10 pb-8 flex justify-evenly gap-4 border-b border-solid border-green border-opacity-25">
          <input
            type="text"
            id="name"
            name="name"
        ...
        <div className="pt-4 z-20 flex justify-between text-green">
          <div className="flex gap-4">
            ...
            <a
              className="uppercase font-narrow hover:cursor-pointer"
              href="https://eat-curious.com/"
              target="_blank"
            >
              Official Eat Curious Website
            </a>
          </div>
